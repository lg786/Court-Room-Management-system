...
from login.views import LoginClientAction, UserChoiceAction, LoginLawyerAction, LoginJudgeAction, LoginAdminAction
from register.views import RegisterClientAction, RegisterJudgeAction, RegisterLawyerAction
from dashboard.views import AdminDashboardAction, ClientDashboardAction, JudgeDashboardAction, LawyerDashboardAction
